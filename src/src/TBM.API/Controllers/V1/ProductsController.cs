...
public class ProductsController : ControllerBase
{
    ...
    /// IsActive, IsFeatured, DisplayOrder, MetaTitle, MetaDescription, Tags
    /// 
    ...
    /// Max file size: 500 rows
    /// </remarks>
    [Authorize(Roles = \"SuperAdmin\")]
    [HttpPost(\"import\")]
    [RequestSizeLimit(10_485_760)] // 10MB max file size
    [DisableRequestSizeLimit] // Remove default limit
    public async Task<IActionResult> Import(IFormFile file)
    {
        ...
        try
        {
            ...
            if (!result.Success)
            {
                // Return partial success with details if some rows failed
                return result.Failed > 0 && result.SuccessfullyImported > 0
