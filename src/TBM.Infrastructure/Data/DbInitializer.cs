...
public static class DbInitializer
{
    public static async Task SeedAsync(ApplicationDbContext context)
    {
        ...
        // Inspiration Designs are seeded via the SeedInspirationDesigns migration
        // (Sql() call) instead of here, so they land in every environment —
        // this method only runs when ASPNETCORE_ENVIRONMENT=Development.
    }
}
